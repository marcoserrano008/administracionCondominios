                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                  <div>
                    ...
                    <input type="number"
                      required
                      aria-describedby="Complete el campo"
                      name="costo" id="costo" value={form.costo} onChange={handleChange} className="py-3 px-4 block w-full border border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" />
                  </div>
          ...
          <div className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 opacity-100 hs-overlay-open:duration-500 mt-0 ease-out transition-all sm:max-w-lg sm:w-full">
            <div className="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-gray-800">
              ...
              <div className="p-4 sm:p-10 text-center overflow-y-auto">
                ...
                <p className="text-sm sm:text-base leading-relaxed text-gray-500">Se registro el servicio</p>
